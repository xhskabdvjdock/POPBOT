...
function initializeMobileUI() {
    ...
    document.querySelectorAll('input, select, textarea').forEach(input => {
        input.addEventListener('invalid', () => {
            ...
            // Add error message that's easy to see on mobile
        ...
        // Clear error styling when user interacts with the field again
...
/**
 * Handle swipe gestures on position cards (for mobile)
 */
function handleSwipe(element, startX, endX) {
    ...
    if (startX - endX > threshold) {
        ...
        // Swipe right - toggle enabled state
...
function initializeNewPositionForm() {
    ...
    if (addQuestionBtn && questionsContainer) {
        ...
        addQuestionBtn.addEventListener('click', () => {
            ...
            // Add delete handler to new question
        ...
        // Add delete handler to initial question
    ...
    // Add character counter for accept message
    ...
    if (cancelBtn) {
        cancelBtn.addEventListener('click', () => {
            ...
            // Clear questions except the first one
            const questionsContainer = document.getElementById('new-position-questions');
...
function initializeEmojiPickers() {
    document.querySelectorAll('.emoji-picker-btn').forEach(btn => {
        ...
        btn.addEventListener('click', () => {
            ...
            // Add picker to DOM and position it
