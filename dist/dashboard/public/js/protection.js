...
function collectProtectionLimits(section) {
    ...
    if (timeWindow) {
        limits.timeWindow = parseInt(timeWindow.value) * 1000; // Convert seconds to milliseconds
    }
...
function collectActionSettings(section) {
    ...
    if (action.type === 'timeout') {
        ...
        action.duration = parseInt(duration) * 60000; // Convert minutes to milliseconds
    }
